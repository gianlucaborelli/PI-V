...
namespace Service.Api.Database.System
{
    ...
    [Migration("20250819031145_AddRiskLimit")]
    partial class AddRiskLimit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Service.Api.Service.SystemManager.Models.RiskLimit", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("RiskLimit");
            ...
            modelBuilder.Entity("Service.Api.Service.SystemManager.Models.IBUTGRiskLimit", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("IBUTGRiskLimit");
                });
            ...
            modelBuilder.Entity("Service.Api.Service.SystemManager.Models.Location", b =>
                {
                    b.HasOne("Service.Api.Service.SystemManager.Models.RiskLimit", "RiskLimit")
                        .WithOne()
                        .HasForeignKey("Service.Api.Service.SystemManager.Models.Location", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
