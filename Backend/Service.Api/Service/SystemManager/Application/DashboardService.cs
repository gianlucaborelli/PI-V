...
namespace Service.Api.Service.SystemManager.Application
{
    public class DashboardService : IDashboardService
    {
        ...
        public async Task<DashboardResponse> GetDashboardDataAsync(Guid moduleId, DateTime? queryDate)
        {
            ...
            //var humiditySensor = await _context.Locations
            ...
            //var dryBulbTemperatureSensor = await _context.Locations
            ...
            //var darkBulbTemperatureSensor = await _context.Locations
